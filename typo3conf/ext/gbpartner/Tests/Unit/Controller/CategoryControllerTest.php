...
/**
 * Test case for class Gigabonus\Gbpartner\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Gigabonus\Gbpartner\Controller\CategoryController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Gigabonus\\Gbpartner\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView()
	{
		...
		$categoryRepository = $this->getMock('Gigabonus\\Gbpartner\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
